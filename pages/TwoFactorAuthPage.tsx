        ...
        <div className="min-h-screen flex items-center justify-center bg-primary p-4">
            <div className="w-full max-w-sm">
                ...
                <div className="bg-primary-light border border-gray-medium rounded-lg shadow-xl p-8">
                    ...
                    <p className="text-center text-gray-light mb-6">Enter the 6-digit code from your authenticator app.</p>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                required
                                maxLength={6}
                                className="mt-1 block w-full bg-gray-dark border border-gray-medium rounded-md shadow-sm py-3 px-4 text-white text-center text-2xl tracking-[0.5rem] focus:outline-none focus:ring-accent focus:border-accent"
                                placeholder="------"
                            />
                        </div>
