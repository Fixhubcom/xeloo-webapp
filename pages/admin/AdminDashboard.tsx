    ...
    return (
        <div className="space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="text-center"><h3 className="text-lg text-gray-500 dark:text-gray-400">Total Users</h3><p className="text-3xl font-bold text-accent">102,495</p></Card>
                <Card className="text-center"><h3 className="text-lg text-gray-500 dark:text-gray-400">Volume (24h)</h3><p className="text-3xl font-bold text-accent">$1.2M</p></Card>
                <Card 
                    className="text-center cursor-pointer hover:border-accent transition-colors"
                    onClick={() => setActiveView('Commission Earnings')}
                >
                    <h3 className="text-lg text-gray-500 dark:text-gray-400">Commission Earned (30d)</h3>
                ...
                >
                    <h3 className="text-lg text-gray-500 dark:text-gray-400">Subscription Earnings (30d)</h3>
...
const AdminDashboard: React.FC = () => {
    ...
    const renderContent = () => {
        switch (activeView) {
            ...
            default: return <AdminOverview setActiveView={selectSidebarItem} />;
        }
    };
        ...
        <div className="flex h-screen bg-slate-50 dark:bg-primary overflow-hidden">
            ...
            <aside className={`w-64 bg-white dark:bg-primary flex flex-col shadow-lg fixed z-30 inset-y-0 left-0 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0`}>
                ...
                <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    ...
                    <NavItemLink icon={<BriefcaseIcon />} label="Partners" activeItem={activeView} setItem={selectSidebarItem} />
                    <NavItemLink icon={<ShoppingBagIcon />} label="Merchants" activeItem={activeView} setItem={selectSidebarItem} />
                    <NavItemLink icon={<UsersIcon />} label="Users" activeItem={activeView} setItem={selectSidebarItem} />
                    ...
                    <NavItemLink icon={<CodeIcon />} label="API" activeItem={activeView} setItem={selectSidebarItem} />
                    <NavItemLink icon={<AnalyticsIcon />} label="Reports" activeItem={activeView} setItem={selectSidebarItem} />
                    <NavItemLink icon={<ShieldCheckIcon />} label="Security" activeItem={activeView} setItem={selectSidebarItem} />
