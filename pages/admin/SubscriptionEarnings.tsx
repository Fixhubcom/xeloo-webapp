        ...
        <div className="space-y-8">
            <div className="flex justify-between items-center">
                ...
                <Card className="text-center p-4">
                    <h3 className="text-sm text-gray-400">Total Earnings ({timeFilter.replace('h', ' hours').replace('d', ' days')})</h3>
                    ...
                    <table className="w-full text-sm text-left text-gray-400">
                        ...
                        <tbody>
                            {filteredSubscriptions.map(s => (
                                <tr key={s.id} className="bg-primary-light border-b border-primary">
                                    <td className="px-6 py-4">{s.date}</td>
                                    <td className="px-6 py-4">
                                        <div className="font-medium text-white">{s.user}</div>
                            ...
                            {filteredSubscriptions.length === 0 && (
                                <tr>
                                    <td colSpan={4} className="text-center py-8 text-gray-400">No subscriptions found for this period.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
