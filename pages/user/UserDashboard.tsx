        ...
        <div className="flex h-screen bg-gray-100 dark:bg-dark-green overflow-hidden">
            ...
            <aside className={`w-64 bg-white dark:bg-primary flex flex-col shadow-lg fixed z-30 inset-y-0 left-0 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0`}>
                ...
                <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    ...
                    <NavItemLink icon={<RefreshIcon />} label="Recurring Payments" activeItem={pageState.view} navigateTo={navigateTo} />
                    <NavItemLink icon={<TransactionsIcon />} label="Transactions" activeItem={pageState.view} navigateTo={navigateTo} />
                    <NavItemLink icon={<InvoiceIcon />} label="Invoices" activeItem={pageState.view} navigateTo={navigateTo} isLocked={!user?.isSubscribed} />
                    <NavItemLink icon={<PayrollIcon />} label="Payroll" activeItem={pageState.view} navigateTo={navigateTo} isLocked={!user?.isSubscribed} />
                    <NavItemLink icon={<ShieldCheckIcon />} label="Escrow" activeItem={pageState.view} navigateTo={navigateTo} />
                    ...
                    <NavItemLink icon={<SubscriptionIcon />} label="Subscription" activeItem={pageState.view} navigateTo={navigateTo} />
                    <NavItemLink icon={<SupportIcon />} label="Support" activeItem={pageState.view} navigateTo={navigateTo} />
                    <NavItemLink icon={<SettingsIcon />} label="Settings" activeItem={pageState.view} navigateTo={navigateTo} />
                </nav>
...
const NavItemLink: React.FC<NavItemLinkProps> = ({ icon, label, activeItem, navigateTo, isLocked }) => {
